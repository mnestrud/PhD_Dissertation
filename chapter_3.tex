...
\centering
\includegraphics[width=0.6\textwidth]{basic_graph.png}
\label{fig:exgraph}
\end{figure}
...
\centering
\includegraphics[width=0.6\textwidth]{cliques.png}
...
\centering
\includegraphics[width=0.9\textwidth]{ind_super_pairgraph.png}
